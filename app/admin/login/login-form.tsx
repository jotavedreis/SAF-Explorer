...
export function LoginForm() {
  ...
  return (
    <form
      ...
      className="admin-login-card w-full max-w-md rounded-[22px] border border-[#d8e0d2]/40 bg-[#f4f5eb]/95 p-4 text-[#132117] shadow-[0_30px_80px_rgba(0,0,0,0.1)] backdrop-blur-sm sm:rounded-[30px] sm:p-6"
    >
      <div>
